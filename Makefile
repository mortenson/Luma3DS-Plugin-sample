...
ASFLAGS		:= $(ARCH)
LDFLAGS		:= -T $(TOPDIR)/3gx.ld $(ARCH) -Os -Wl,-Map,$(notdir $*.map),--gc-sections
...
copy-local:
	cp ./Luma3DS-Plugin-sample.3gx /mnt/c/Users/Sam/AppData/Roaming/Citra/sdmc/luma/plugins/default.3gx

copy-ftp:
	curl --netrc --upload-file Luma3DS-Plugin-sample.3gx ftp://192.168.0.204:5000/luma/plugins/default.3gx
